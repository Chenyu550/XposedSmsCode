...
- 数据与转发链路升级到新阶段：新增 `DB v15/v16` 迁移，补齐通话通知记录字段，并引入应用通知双向路由（`应用->通道` 与 `通道->应用` 交集判定）。
...
- 版本升级到 `versionCode 98` / `versionName 3.1.7-beta`。

> Full Changelog: https://github.com/magisk317/XposedSmsCode/compare/v3.1.6...v3.1.7-beta
