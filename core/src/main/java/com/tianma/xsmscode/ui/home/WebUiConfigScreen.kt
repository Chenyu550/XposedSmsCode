...
import com.tianma.xsmscode.common.utils.WebUiCertificateHelper
                ...
                Column(
                    ...
                    if (webUiEnabled) {
                        ...
                        Row(
                            ...
                            Button(
                                onClick = {
                                    exportCertLauncher.launch("xsmscode-webui-cert.cer")
                                },
                                modifier = Modifier.weight(1f),
                            ) {
                        ...
                        Row(
                            ...
                            Button(
                                onClick = {
                                    exportP12Launcher.launch("xsmscode-webui-cert-with-key.p12")
                                },
                                modifier = Modifier.weight(1f),
                            ) {
