package com.github.magisk317.smscode.ui.forwardfilter
...
fun ForwardFilterMsgTypeTabs(
    ...
    TabRow(selectedTabIndex = msgTypeTabs.indexOfFirst { it.first == selectedMsgType }.coerceAtLeast(0), modifier = modifier) {
